// make sure you have amcharts5 in your "node_modules" folder before bundling
...
async function SolPrice() {
  setTimeout(async () => {
    const target = document.querySelector(
      ".c-header .l-col.l-col-auto-lg.l-col-xl .u-d-flex.u-align-items-center.u-justify-content-end"
    );
...
// MAIN
if ( window.location.hostname == "photon-sol.tinyastro.io" && window.location.href.includes('/en/lp/') ) {
    HoldersTabSetHeight();
